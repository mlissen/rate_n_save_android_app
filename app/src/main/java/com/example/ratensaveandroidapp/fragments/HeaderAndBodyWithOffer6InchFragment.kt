...
import com.example.ratensaveandroidapp.HomeActivity // Import HomeActivity
...
class HeaderAndBodyWithOffer6InchFragment : Fragment() {
    ...
    private fun updateUI(adResponse: AdResponse) {
        // Set header, body, and footer text
        binding.couponHeaderTextView.text = adResponse.content?.header ?: ""
        binding.couponOfferTextView.text = adResponse.content?.body ?: ""
        binding.couponFooterTextView.text = adResponse.content?.terms ?: ""
